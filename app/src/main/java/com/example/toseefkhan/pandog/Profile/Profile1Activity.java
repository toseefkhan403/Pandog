...
public class Profile1Activity extends AppCompatActivity {
    ...
    private Context mContext = Profile1Activity.this;
...
//        tempGridSetup();
    ...
    private void init(){
        ...
        android.support.v4.app.FragmentTransaction transaction = Profile1Activity.this.getSupportFragmentManager().beginTransaction();
