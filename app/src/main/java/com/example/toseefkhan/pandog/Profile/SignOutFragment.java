...
import com.example.toseefkhan.pandog.Login.LoginActivity;
...
public class SignOutFragment extends Fragment {
   ...
   private ImageView ivSignOut;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ivSignOut=(ImageView) view.findViewById(R.id.ivSignOut);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Log.d(TAG, "onAuthStateChanged: navigating back to the login activity");
