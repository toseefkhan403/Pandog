...
import com.example.toseefkhan.pandog.Models.Photo;
import com.example.toseefkhan.pandog.Models.User;
import com.example.toseefkhan.pandog.Models.UserAccountSettings;
import com.example.toseefkhan.pandog.Models.UserSettings;
...
import com.example.toseefkhan.pandog.Utils.ImageManager;
import com.example.toseefkhan.pandog.Utils.StringManipulation;
...
public class FirebaseMethods {
    ...
    private void setProfilePhoto(String url) {
        ...
        myRef.child(mContext.getString(R.string.dbname_user_accountsettings))
...
//    }
    ...
    public UserSettings getUserSettings(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            if (ds.getKey().equals(mContext.getString(R.string.dbname_user_accountsettings))) {
